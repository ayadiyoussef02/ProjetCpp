...
//pie chart
    ...
    q1.prepare("SELECT * FROM FORMATIONS");
    q1.exec();

    q2.prepare("SELECT * FROM FORMATIONS WHERE DESCRIPTION='Formations'");
    q2.exec();

    q3.prepare("SELECT * FROM FORMATIONS WHERE DESCRIPTION='Conferences'");
    q3.exec();
    ...
    series->append("Formations",c1);
    series->append("Conferences",c2);
